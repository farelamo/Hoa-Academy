...
@section('content')
                            ...
                            <td>
                                <div class="d-flex justify-content-center">
                                    <a href="#" class="h3" data-bs-toggle="modal" data-bs-target="#edit"
                                        onclick='edit("{{ $vocab->id }}")'>
                                        <i class="fas fa-edit m-1"></i>
                                    </a>
                                    <p id="{{ $vocab->id }}" class="d-none">
                                        {{ $vocab->name }}
                                    </p>

                                    <a href="#" class="h3" data-bs-toggle="modal" data-bs-target="#hapus"
                                        onclick='hapus("{{ $vocab->id }}")'>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Tambah Vocabulary</h5>
    ...
    <div class="modal fade" id="hapus" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Hapus Vocabulary</h5>
                    <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                    </button>
                </div>
                <div class="modal-body">
...
@section('script')
    <script type="text/javascript">
        function edit(id) {
            ...
            document.getElementById('formEdit').action = "/admin/vocabulary/" + id;
        }
        ...
        function hapus(id) {
            ...
            document.getElementById('formHapus').action = "/admin/vocabulary/" + id;
        }
    </script>
@endsection
