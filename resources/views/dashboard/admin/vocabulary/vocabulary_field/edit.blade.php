    ...
    <div class="container">
        <div class="card p-5">
            <div class="d-flex justify-content-between mb-3">
                <div>
                    <h3>Edit Vocabulary Field</h3>
                </div>
            </div>
            <div class="card-body">
                <form action="/admin/vocabulary/field/{{$vocab_field->id}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row mb-3">
                        <div class="col-6">
                            ...
                            <input type="text" class="form-control" id="word" name="word"
                                value="{{ old('word') ?? $vocab_field->word }}">
                            @error('word')
                        ...
                        <div class="col-6">
                            ...
                            <input type="text" class="form-control" id="vocal" name="vocal"
                                value="{{ old('vocal') ?? $vocab_field->vocal }}">
                            @error('vocal')
                            <div class="error">*{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="mean" name="mean"
                                    value="{{ old('mean') ?? $vocab_field->mean }}">
                                @error('mean')
                                    <div class="error">*{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-6">
                            <div class="mb-3">
                                ...
                                <input type="file" class="form-control px-4" id="sound" name="sound"
                                    value="{{ old('sound') ?? $vocab_field->sound }}">
                                @error('sound')
                                    <div class="error">*{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-6">
                            <select name="vocabulary_id" class="form-select select_box">
                                ...
                                @foreach ($vocabs as $vocab)
                                    @if (old('vocabulary_id') ?? $vocab_field->vocabulary_id == $vocab->id)
                        ...
                        <div class="col-6">
                            <select name="vocabulary_category_id" class="form-select select_box">
                                ...
                                @foreach ($vocabCats as $vocabCat)
                                    @if (old('vocabulary_category_id') ?? $vocab_field->vocabulary_category_id == $vocabCat->id)
