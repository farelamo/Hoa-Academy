                        ...
                        <div class="col">
                            <div class="form-group">
                                <div class="col">
                                    ...
                                    <input type="text" class="form-control" name="title" placeholder="Judul Blog" value="{{ old('title') }}">
                                    @error('title')
                        ...
                        <div class="col">
                            <div class="form-group">
                                <div class="col">
                                    ...
                                    <input type="text" class="form-control" name="shortDesc" placeholder="Desc Singkat" value="{{ old('shortDesc') }}">
                                    @error('shortDesc')
                                        <div class="error">*{{ $message }}</div>
                                    @enderror
                                </div>
